...
describe('RegressionFactory', () => {
    ...
    describe('can create', () => {
        it('Linear', () => {
            let regression: Regression = factory.create(RegressionType.LINEAR, [
                0,
                2
            ]);
        ...
        it('Exponential', () => {
            let regression: Regression = factory.create(RegressionType.EXPONENTIAL, [
                0,
                2
            ]);
        ...
        it('Logarithmic', () => {
            let regression: Regression = factory.create(RegressionType.LOGARITHMIC, [
                0,
                10
            ]);
        ...
        it('Polynomial', () => {
            let regression: Regression = factory.create(RegressionType.POLYNOMIAL, [
                2,
                0
            ]);
        ...
        it('Power', () => {
            let regression: Regression = factory.create(RegressionType.POWER, [
                1,
                1
            ]);
